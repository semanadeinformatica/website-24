...
<body class="bg-2024-bg">
    <table class="m-0 p-0 w-full bg-2024-bg" width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td align="center">
                <table class="m-0 p-0 w-full" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="w-full" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <table class="mx-auto max-w-xl border shadow-lg shadow-2024-blue w-full" align="center"
