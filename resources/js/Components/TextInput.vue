...
const baseClass =
    "peer border border-black bg-2024-bg shadow-md shadow-2024-blue px-3 pb-2 pt-6 disabled:opacity-50 disabled:text-gray-500 disabled:shadow-gray-500 disabled:shadow-md";
...
<template>
    <div class="relative flex flex-col items-stretch self-stretch">
        ...
        <label
            v-if="label"
            :for="id"
            class="pointer-events-none absolute left-3 top-2 text-xs font-semibold text-2024-black transition-all peer-disabled:text-gray-500 peer-disabled:opacity-50 peer-placeholder-shown:peer-[&:not(:focus)]:top-4 peer-placeholder-shown:peer-[&:not(:focus)]:text-base"
        ...
        <button
            v-if="type === 'password'"
            type="button"
            class="absolute right-2 top-2 p-2 leading-4 text-2024-black peer-disabled:text-gray-500 peer-disabled:opacity-50"
