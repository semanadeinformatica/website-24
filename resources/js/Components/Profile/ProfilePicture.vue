...
<template>
    <div class="flex flex-col items-end max-md:mb-6">
        <div
            class="h-48 w-48 overflow-hidden border-4 border-solid border-2024-black max-md:ml-8"
        >
            <img
