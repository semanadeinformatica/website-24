...
<template>
    <div class="flex w-full flex-col py-12 md:px-32">
        <div
            class="flex justify-between border-solid border-black bg-2024-light-blue p-3 px-8 font-bold text-2024-bg"
        ...
        <div
            class="mx-4 h-fit items-center justify-center border-x border-b border-solid border-black bg-2024-black p-6 font-bold text-2024-bg max-md:mx-2"
