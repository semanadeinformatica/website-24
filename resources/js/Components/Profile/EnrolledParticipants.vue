...
<template>
    ...
    >
        <div class="flex w-full flex-col md:flex-row md:justify-between">
            <h2 class="p-3 text-2xl font-bold text-2024-black">
                Participantes que visitaram a sua empresa: {{ visitors.length }}
            </h2>
            <a
                v-if="$page.props"
                class="inline-flex items-center justify-center border border-black bg-2024-blue px-4 py-2 text-center text-xl font-bold text-white shadow-2024-black transition-shadow hover:shadow"
        ...
        <div
            class="flex w-full flex-col items-center border border-black bg-2024-bg shadow-lg shadow-2024-black"
        >
            <div
                v-for="visitor in visitors"
                :key="visitor.id"
                class="flex w-full items-center justify-between p-3 even:bg-2024-blue even:bg-opacity-20"
            >
