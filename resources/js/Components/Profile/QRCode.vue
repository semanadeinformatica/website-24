...
<template>
    ...
    <VueFinalModal
        ...
        content-class="max-w-xl min-w-[20em] mx-4 p-8 pt-12 gap-8 bg-2024-bg border border-black border-solid flex relative justify-center items-center flex-col"
    >
        <span v-if="loading" class="text-lg">A gerar...</span>
        <template v-else>
            <div v-html="participant.quest_qr_code"></div>
            <span class="font-mono font-bold text-2024-light-blue">
