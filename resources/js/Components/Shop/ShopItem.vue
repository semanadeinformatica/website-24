...
<template>
    <div class="flex max-w-[20em] flex-col border-2 border-black">
        ...
        <button
            class="flex flex-1 flex-col justify-between bg-2024-blue px-4 py-2 text-white disabled:opacity-50"
    ...
    <VueFinalModal
        ...
        content-class="max-w-xl max-h-[80%] mx-4 p-4 bg-2024-bg border border-black border-solid flex relative justify-center items-center flex-col gap-8"
    >
