...
<template>
    <div class="transition-all duration-500">
        <div
            class="relative flex w-fit flex-col items-center overflow-x-hidden overflow-y-hidden "
        >
            <img
                :src="speaker.profile_photo_url"
                class="h-52 w-52 border-2 border-solid border-2024-light-blue object-cover"
                alt=""
            />
            <div
                v-if="Object.keys(socialMedia).length > 0"
                class="socials absolute -bottom-32 flex w-full flex-row items-center justify-center bg-2024-light-blue pb-10 pt-1 transition-all"
            >
                <a
        ...
        <p class="max-w-52 break-words py-4 text-lg text-2024-light-blue">
