...
<template>
    <VueFinalModal
        ...
        content-class="max-w-xl mx-4 p-4 bg-2024-bg border border-black border-solid flex relative justify-center items-center flex-col gap-8"
        @closed="cacheSeenInfo()"
    >
        <div
            class="flex flex-col items-center gap-6 text-center text-xl text-2024-light-blue"
        >
            <img class="w-80" src="images/sinf logo.png" />
            <p>
                A <span class="font-bold text-2024-black">SINF</span> está
