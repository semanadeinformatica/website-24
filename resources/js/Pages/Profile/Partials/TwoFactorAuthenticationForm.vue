    ...
    <ActionSection>
        ...
        <template #content>
            <h3
                ...
                class="text-lg font-medium text-2024-black"
            >
            ...
            <div class="mt-3 max-w-xl text-sm text-2024-light-blue">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-2024-light-blue">
                    ...
                    <div
                        class="mt-4 inline-block bg-2024-bg p-2"
                        v-html="qrCode"
                    />

                    <div
                        v-if="setupKey"
                        class="mt-4 max-w-xl text-sm text-2024-light-blue"
                    >
