    ...
    <AdminLayout title="Administrador">
        ...
        >
            <template v-for="(label, page) in pageRoutes" :key="page">
                <a
                    class="w-full place-self-center break-words border border-black bg-2024-light-blue p-6 text-center text-white shadow-2024-blue transition-all hover:shadow-md"
                    :href="route(page)"
                    >{{ $t(label, 2) }}</a
                >
            </template>
