const messages = {
    ...
    pt: {
        homePage: {
            ...
            aboutUsText2:
                "A edição de 2024 decorre entre os dias 21 e 13 de outubro. Os participantes têm a seu dispor palestras e workshops onde entrarão em contacto com diversas tecnologias e conceitos que não intervêm no percurso académico, focando-se portanto nas skills técnicas, assim como uma atividade de escape room, fomentando o seu contacto uns com os outros, podendo desenvolver as suas soft skills."
        },
        general: {
            to: "a",
        },
